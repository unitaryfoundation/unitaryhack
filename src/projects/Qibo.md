...
QiboML is the module dedicated to quantum machine learning applications which provides integrations with classical AI tools such as pytorch and tensorflow.
