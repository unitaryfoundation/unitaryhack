...
def build_email_body(hacker, username):
    ...
    email_contents += f"""\n\nIf the above information looks correct to you (please double check!), then you're ready to get paid! We'll need to collect some information from you in order to make this happen. Would you please submit a (single!) response to [this form]({BOUNTY_WINNER_FORM}) at your earliest convenience? Once we have the necessary information, we can begin processing your payment."""
